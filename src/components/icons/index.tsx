...
export function GovernanceIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CubeIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BoxIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CheckSquareIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LoginIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
